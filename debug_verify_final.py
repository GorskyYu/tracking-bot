"""Verify: native PyMuPDF render (no rotation) + GPT-4o = correct result"""
...
# Exact same as new production code
pix = page.get_pixmap(matrix=fitz.Matrix(3, 3))
img = Image.frombytes("RGB", [pix.width, pix.height], pix.samples)
print(f"Image size: {img.size}, portrait={img.height > img.width}")
img.save("verify_final.jpg")
