...
# STRICT FEDEX PROMPT: Demands exact transcription and warehouse blacklisting.
FEDEX_SHIPPING_PROMPT = """
Task: Extract sender (name, phone, client ID, address), receiver postal code, 
and Reference Number from this shipping ticket.
1. NAME: The first line. Capture Name directly under the letters "FROM:", which can include brackets and dash. Display exactly as printed, letter by letter.
2. CLIENT ID: The SECOND line (e.g., 'Lammond'). Do NOT leave empty if text is there.
3. ADDRESS: Combine all remaining address lines into ONE single line. Use spaces ONLY; do NOT include newlines or '\\n'.
4. REFERENCE: Capture the exact string after 'REF:'. It is located to the right of the address.
Response Format: {"sender": {"name": "", "phone": "", "client_id": "", "address": ""}, 
"receiver": {"postal_code": ""}, "reference_number": ""}
"""
