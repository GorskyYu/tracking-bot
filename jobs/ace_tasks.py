...
LINE_HEADERS = {"Content-Type": "application/json", "Authorization": f"Bearer {LINE_TOKEN}"}

# 這裡放入你原本 main.py 裡的 ACE 相關 Function
# 包括 _ace_collect_today_box_ids, push_ace_today_shipments, ace_today_cron_tick

def get_gspread_client():
    """與 main.py 邏輯一致的 Google Sheet 認證"""
    import base64, json
    ...
    if b64:
        ...
        raise RuntimeError("Missing credentials for Google Sheets")
